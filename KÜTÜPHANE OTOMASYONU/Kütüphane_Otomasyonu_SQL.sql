...
INSERT INTO Admin (adminAd, adminSoyad, adminSifre, adminTcNo, adminEposta, adminCepTelefon, adminAdres)
VALUES ('Sýla', 'Dertli', 'Sila123', '12345678901', 'sila@gmail.com', '5537305892', 'Düzce, Merkez');
--
...
-- 1. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-3-16-148410-0')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('Veri Yapýlarý', 'Bilgisayar Bilimleri', 1, '978-3-16-148410-0', 45.99, 1, 1, 'Ahmet', 'Yýlmaz', '2019-05-20', 320, 'Bilgisayar Yayýnlarý');

-- 2. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-1-23-456789-0')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('Algoritmalar', 'Bilgisayar Bilimleri', 2, '978-1-23-456789-0', 39.50, 2, 1, 'Ayþe', 'Demir', '2018-08-15', 250, 'Yazýlým Yayýnlarý');
...
-- 4. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-9-87-654321-2')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('Aðlar ve Daðýtýk Sistemler', 'Bilgisayar Bilimleri', 3, '978-9-87-654321-2', 65.90, 4, 1, 'Fatma', 'Çetin', '2021-03-25', 350, 'Að Yayýnlarý');

-- 5. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-4-56-789123-3')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('Yazýlým Mühendisliði', 'Bilgisayar Bilimleri', 1, '978-4-56-789123-3', 75.25, 5, 1, 'Ali', 'Öztürk', '2022-01-12', 280, 'Mühendislik Yayýnlarý');
...
-- 9. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-7-89-012345-5')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('C++ Programlama', 'Yazýlým Geliþtirme', 1, '978-7-89-012345-5', 60.75, 4, 0, 'David', 'Martinez', '2020-06-25', 350, 'C++ Yayýnlarý');

-- 10. Kitap Giriþi
IF NOT EXISTS (SELECT 1 FROM Kitap WHERE ISBN = '978-2-34-567890-6')
INSERT INTO Kitap (kitapAd, kategoriAd, baskiNo, ISBN, gelisFiyat, kutuphaneID, raftaDurum, yazarAd, yazarSoyad, basimYil, sayfaSayi, yayinEvi)
VALUES ('Ýleri Python Programlama', 'Yazýlým Geliþtirme', 2, '978-2-34-567890-6', 69.99, 5, 1, 'Emily', 'Brown', '2021-04-17', 420, 'Python Yayýnlarý');
