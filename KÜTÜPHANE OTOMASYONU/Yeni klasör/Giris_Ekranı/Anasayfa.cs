        ...
        private void yedek_button_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string databaseName = "HAHAHA"; // Yedeklenecek veritabanı adı
        ...
        private void yedekdon_button_Click(object sender, EventArgs e)
        {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string connectionString = "Server=DESKTOP-JLM9DM4\\HANIFESQL;Integrated Security=True;"; // Sunucu adı ve bağlantı
                    ...
                    SELECT @kill = @kill + 'KILL ' + CONVERT(varchar(5), session_id) + ';'
                    FROM sys.dm_exec_sessions
                    WHERE database_id = DB_ID('HAHAHA') AND session_id <> @@SPID; -- Kendi oturumumuzu dışarıda bırakıyoruz
                    EXEC(@kill);";
                            ...
                            string restoreQuery = $@"
                    RESTORE DATABASE HAHAHA 
                    FROM DISK = '{backupPath}' 
                    WITH REPLACE, 
                         MOVE 'HAHAHA' TO 'C:\\Program Files\\Microsoft SQL Server\\MSSQL16.HANIFESQL\\MSSQL\\DATA\\HAHAHA.mdf', 
                         MOVE 'HAHAHA_log' TO 'C:\\Program Files\\Microsoft SQL Server\\MSSQL16.HANIFESQL\\MSSQL\\DATA\\HAHAHA_log.ldf'";
